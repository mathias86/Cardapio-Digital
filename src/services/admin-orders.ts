...
const orderSchema = z.object({
  ...
  items: z.array(z.object({ id: z.uuid(), product_name: z.string(), quantity: z.number(), unit_price: databaseNumber, total_price: databaseNumber, notes: z.string().nullable() })),
});
