...
const defaults: SettingsFormValues = { name: "", logo_url: "", is_open: true, delivery_fee: 0, delivery_price_per_km: 0, minimum_order_value: 0, phone: "", whatsapp: "", address: "", pix_key: "", pix_name: "" };
